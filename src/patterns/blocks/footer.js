...
export const footer = {
  ...
  settings: {
    ...
    logoWidth: 124,
    logoLink: '#',
    logoUrl: 'https://image.sendsay.ru/image/setpartnerstv/mail_footer_logo.png',
    ...
    vkIcon: 'https://image.sendsay.ru/image/setpartnerstv/mail_gazprombonus_vk_b.png',
    telegramLink: 'https://t.me/gazprombonus_podpiska',
    telegramIcon: 'https://image.sendsay.ru/image/setpartnerstv/mail_gazprombonus_tg_b.png',
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      label: 'Межстрочный интервал сносок (px,%)',
    },
    {
...
<div class="footer-legal" contenteditable="true"
     data-editable="legal"
     style="
        font-family:Arial, sans-serif;
